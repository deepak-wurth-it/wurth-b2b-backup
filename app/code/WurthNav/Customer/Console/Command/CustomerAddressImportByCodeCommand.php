...
class CustomerAddressImportByCodeCommand extends Command
{
    ...
    {
        $this->setName('nav:customer:address:import')
            ->setDescription('Importing Customer Address From CustomerDeliveryAddress');
