...
class SaveOrderDetailByRest implements ObserverInterface
{
...
//            }
            ...
            if (isset($postData['additional_properties'])) {
                $deliveryAddressCode = isset($postData['additional_properties']['order_confirmation_email']) ? $postData['additional_properties']['order_confirmation_email'] : '';
