...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        parent::_construct();
        $this->_init('Plazathemes\Blog\Model\Category', 'Plazathemes\Blog\Model\ResourceModel\Category');
    ...
    protected function _afterLoad()
    {
        ...
        if (count($items)) {
            ...
            $select = $connection->select()->from(['cps' => $this->getTable('plazathemes_blog_category_store')])
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                ['store_table' => $this->getTable('plazathemes_blog_category_store')],
