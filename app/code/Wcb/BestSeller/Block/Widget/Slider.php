...
namespace Wcb\BestSeller\Block\Widget;
...
/**
 * Class Slider
 * @package Wcb\BestSeller\Block\Widget
 */
class Slider extends AbstractSlider
{
    ...
    protected $_template = "Wcb_BestSeller::widget/productslider.phtml";
    ...
    public function _construct()
    {
        ...
        $this->setTemplate('Wcb_BestSeller::widget/productslider.phtml');
    }
