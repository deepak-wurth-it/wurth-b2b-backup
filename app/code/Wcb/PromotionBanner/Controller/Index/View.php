...
class View extends Action
{
    ...
    public function execute()
    {
        ...
        if ($this->_promotionBanner->getEnable()) {
            ...
            $currentCustomerGroup = $this->_promotionBanner->getCustomerGroupId();
        }

        $data = ['currentproductid' => $currentProductId, 'banners' => $banners, 'cl' => $customerLoggedIn, 'ccg' => $currentCustomerGroup];
