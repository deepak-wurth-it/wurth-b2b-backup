...
class Save extends \Wcb\Blog\Controller\Adminhtml\Items
{
            ...
            try {
                ...
                if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
                    try{
                        ...
                        $destinationPath = $mediaDirectory->getAbsolutePath('wcb/blog');
                        ...
                        $imagePath = 'wcb/blog'.$result['file'];
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('wcb_blog/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('wcb_blog/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('wcb_blog/*/new');
                }
                return;
            } catch (\Exception $e) {
                ...
                $this->_redirect('wcb_blog/*/edit', ['id' => $this->getRequest()->getParam('id')]);
                return;
            }
        }
        $this->_redirect('wcb_blog/*/');
