...
return [
    'modules' => [
        ...
        'Wcb_Catalogslider' => 1,
        'Wcb_Component' => 1,
        'Wcb_CustomerRegistration' => 1,
        'Wcb_Demonotices' => 1,
        'Wcb_HomePage' => 1,
        'Wcb_Megamenu' => 1,
        'Wcb_NewFeature' => 1,
        'Wcb_PromotionBanner' => 1,
        'Wcb_QuantityImport' => 1,
        'Wcb_Registrationblock' => 1,
        'Wcb_Store' => 1,
        'Wcb_Testimonials' => 1,
        'Wcb_UrlRewrite' => 1,
        'WurthNav_Core' => 1,
